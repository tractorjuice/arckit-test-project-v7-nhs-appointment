# NHS Digital Appointment Service Enterprise Architecture Principles
...
| **Reviewed By** | PENDING |
| **Approved By** | PENDING |
| **Distribution** | All project teams, suppliers, and stakeholders |

## Revision History

| Version | Date | Author | Changes | Approved By | Approval Date |
|---------|------|--------|---------|-------------|---------------|
| 1.0 | 2026-01-22 | ArcKit AI | Initial creation from `/arckit:principles` command | PENDING | PENDING |
| 1.1 | 2026-02-10 | ArcKit AI | Minor content refresh and version increment | PENDING | PENDING |
...
|---------|------|--------|---------|
| 1.0 | 2026-01-22 | ArcKit AI | Initial draft |
| 1.1 | 2026-02-10 | ArcKit AI | Minor content refresh and version increment |
...
**Project**: NHS Digital Appointment Service (Global) (Project 000)
